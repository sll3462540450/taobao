...
const get = (name, url, config) => ({
  name,
  url,
  method: 'get',
  ...config
})
const post = (name, url, config) => ({
  name,
  url,
  method: 'post',
  ...config
